<div class="bg-white rounded-lg p-8">
    ...
    <div class="mb-8 w-full h-full text-xs ">
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="flex items-center space-x-3 w-full md:w-auto">
                            <button id="actionsDropdownButton2" data-dropdown-toggle="actionsDropdown"
                            ...
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row"
                                    ...
                                    <div class=" p-0 m-0 flex items-center justify-start gap-2">
                                        <img src="{{ url('images/partners/partnerImage1.png')}}" class=" h-5 w-5"
                                            alt="">
                                        ...
                                        <svg width="12" height="12" viewBox="0 0 16 16" fill="none"
                                            ...
                                            <g clip-path="url(#clip0_131_5034)">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    ...
                                                    fill="#4EA685" stroke="#4EA685" stroke-linejoin="round" />
                                            </g>
                                            <defs>
                                ...
                                <td class="px-4 py-3">
                                    <p>This platform is fantastic! I was trying to better manage and create more fleets
                                        for business, this made things easy. Try adding a range pagination for the forms
                                        though.</p>
                                </td>
