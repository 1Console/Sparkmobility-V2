...
<div class="mb-5 grid grid-cols-1 md:grid-cols-3 gap-4">
    ...
    <div class="relative p-8 max-w-sm bg-white rounded-lg shadow flex items-center space-y-0.5">
        <span
            class="absolute top-3 right-3 bg-brand-100 text-xxs font-medium tracking-wide text-brand-400 rounded-full px-2 py-0.5">505
            Active</span>
        ...
        <div>
            ...
            <p class="text-sm text-zinc-500">Manage all riders</p>
        </div>
    </div>

    <div class="relative p-8 max-w-sm bg-white rounded-lg shadow flex items-center space-y-0.5">
        <span
            class="absolute top-3 right-3 bg-brand-100 text-xxs font-medium tracking-wide text-brand-400 rounded-full px-2 py-0.5">05
            Active</span>
        <div class="shrink-0 mr-5">
        ...
        <div>
            <div class="text-xl font-medium text-gray-600">Fleets</div>
            <p class="text-sm text-zinc-500">Manage all fleets</p>
        </div>
    </div>

    <div class="relative p-8 max-w-sm bg-white rounded-lg shadow flex items-center">
        <span
            class="absolute top-3 right-3 bg-brand-100 text-xxs font-medium tracking-wide text-brand-400 rounded-full px-2 py-0.5">215
            In service</span>
        <div class="shrink-0 mr-5">
            <svg class="size-9" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div>
            <div class="text-xl font-medium text-gray-600">Vehicles</div>
            <p class="text-sm text-zinc-500">Manage all vehicles</p>
        </div>
    </div>
</div>

<div class="mb-5 bg-white shadow border border-gray-200 rounded-lg p-8">
    <div class="flex flex-col space-y-2 md:flex-row md:justify-between">
        <div class="space-y-1">
            <h3 class="text-lg font-bold">Management Insight</h3>
            <p>Monitor performance by month and year</p>
        </div>

        <div class="inline-flex space-x-3">
            <div>
                <button data-dropdown-toggle="lastDaysdropdown" data-dropdown-placement="bottom" type="button"
                    class="px-4 py-2 inline-flex items-center text-sm font-thin text-gray-500 focus:outline-none bg-white rounded-full border border-gray-200 hover:border-brand-400 hover:text-brand-400 focus:z-20 focus:ring-2 focus:ring-brand-200">
                    This week

                    <svg class="size-5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24">
                ...
                <div id="lastDaysdropdown"
                    class="z-20 hidden bg-white divide-solid divide-y divide-gray-400 rounded-lg shadow w-44">
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400">Yesterday</a>
                        </li>
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400">Today</a>
                        </li>
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400">Last
                                7 days</a>
                        </li>
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400">Last
            ...
            <div>
                <button data-dropdown-toggle="monthsDropdown" data-dropdown-placement="bottom" type="button"
                    class="px-4 py-2 inline-flex items-center text-sm font-thin text-gray-500 focus:outline-none bg-white rounded-full border border-gray-200 hover:border-brand-400 hover:text-brand-400 focus:z-20 focus:ring-2 focus:ring-brand-200">
                    This year
                ...
                <div id="monthsDropdown"
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400">January</a>
                        </li>
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400">February</a>
                        </li>
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400">March</a>
                        </li>
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400">April</a>
                        </li>
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400">May</a>
                        </li>
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400">June</a>
                        </li>
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400">July</a>
                        </li>
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400">August</a>
                        </li>
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400">September</a>
                        </li>
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400">October</a>
                        </li>
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400">Novemebr</a>
                        </li>
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400">December</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="mt-10 w-full">
        ...
        <div class="flex justify-end my-4">
            <a href="#"
                class="uppercase text-sm font-medium inline-flex items-center rounded-lg text-brand-400 hover:font-semibold hover:text-brand-400 hover:bg-gray-100 px-3 py-2">
                Users Report

                <svg class="size-5 ms-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                        d="m9 16 4-4-4-4" />
                </svg>
