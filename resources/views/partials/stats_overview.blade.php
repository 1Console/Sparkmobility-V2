...
<div class="mb-5 rounded-lg border border-gray-200 bg-white p-8 shadow">
		...
		<div class="inline-flex space-x-3">
			<div>
				<button
					...
					type="button"
					class="inline-flex items-center rounded-full border border-gray-200 bg-white px-4 py-2 text-sm font-thin text-gray-500 hover:border-brand-400 hover:text-brand-400 focus:z-20 focus:outline-none focus:ring-2 focus:ring-brand-200"
				>
					This week
				...
				<div
					id="lastDaysdropdown"
					class="z-20 hidden w-44 divide-y divide-solid divide-gray-400 rounded-lg bg-white shadow"
				>
					<ul
					...
					>
						<li>
							<a
								href="#"
								class="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400"
							>
								Yesterday
							</a>
						</li>
