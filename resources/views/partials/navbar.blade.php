    ...
    <nav class="bg-white border-b border-gray-200 shadow px-4 lg:px-6 py-2.5">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center">
            ...
            <div class="flex justify-between md:justify-end items-center lg:order-2 space-x-0">
                <!-- CTA -->
                {{-- <button type="button"
                    class="hidden sm:inline-flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-xs px-3 py-1.5 mr-2"><svg
                ...
                <span class="hidden sm:inline-flex items-center text-sm shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-4 h-4 mr-1 text-slate-500">
