			...
			<div class="flex items-center justify-between space-x-2 md:justify-end lg:order-2">
				...
				<div class="hidden shrink-0 items-center justify-center md:flex">
					...
					>
						...
						<hr class="w-5 rotate-90 text-gray-400" />
				...
				<button
					type="button"
					class="mx-3 flex rounded-full bg-gray-800 text-sm focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600 md:mr-0 md:hidden"
					id="user-menu-button"
					aria-expanded="false"
					data-dropdown-toggle="dropdown"
				>
