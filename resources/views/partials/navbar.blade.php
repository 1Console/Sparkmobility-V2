...
<header class="fixed z-30 w-full antialiased">
    <nav class="bg-white border-b border-gray-200 shadow px-4 lg:px-6 py-2.5">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center">
            <div class="flex justify-start items-center">
                {{-- toggle sidebar start --}}
                <button id="toggleSidebar" aria-expanded="true" aria-controls="sidebar"
                    class="hidden p-2 mr-2 text-gray-600 rounded cursor-pointer lg:inline hover:text-gray-900 hover:bg-gray-100">
                ...
                <a href="/" class="flex mr-6">
                    ...
                    <img class="w-20 ms-3" src="{{ url('images/TrekkLogo.png')}}" alt="Trekk Logo">
                </a>
            ...
            <div class="flex justify-between md:justify-end items-center lg:order-2 space-x-0">
                {{-- Date --}}
                <span class="hidden sm:inline-flex items-center text-sm shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-4 mr-1 text-slate-500">
                ...
                <button type="button" data-dropdown-toggle="notification-dropdown"
                    ...
                    <!-- Bell icon -->
                    <svg class="size-5 text-gray-800 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24">
                ...
                <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg"
                    ...
                    <div>
                        <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100">
                            <div class="flex-shrink-0">
                                ...
                                <div
                                    class="flex absolute justify-center items-center ml-6 -mt-5 size-5 rounded-full border border-white bg-primary-700">
                                    <svg class="size-2 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="pl-3 w-full">
                                ...
                                <div class="text-xs font-medium text-primary-700">a few moments
                                    ago</div>
                            </div>
                        </a>
                        <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100">
                            <div class="flex-shrink-0">
                                ...
                                <div
                                    class="flex absolute justify-center items-center ml-6 -mt-5 size-5 bg-gray-900 rounded-full border border-white">
                                    <svg class="size-2 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="pl-3 w-full">
                                <div class="text-gray-500 font-normal text-sm mb-1.5"><span
                                    ...
                                    following you.</div>
                                <div class="text-xs font-medium text-primary-700">10 minutes ago
                                </div>
                            </div>
                        </a>
                        <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100">
                            <div class="flex-shrink-0">
                                ...
                                <div
                                    class="flex absolute justify-center items-center ml-6 -mt-5 size-5 bg-red-600 rounded-full border border-white">
                                    <svg class="size-2 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        fill="currentColor" viewBox="0 0 20 18">
                                        <path
                        ...
                        <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100">
                            <div class="flex-shrink-0">
                                ...
                                <div
                                    class="flex absolute justify-center items-center ml-6 -mt-5 size-5 bg-green-400 rounded-full border border-white">
                                    <svg class="size-2 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        fill="currentColor" viewBox="0 0 20 18">
                                        <path
                        ...
                        <a href="#" class="flex py-3 px-4 hover:bg-gray-1000">
                            <div class="flex-shrink-0">
                                <img class="size-11 rounded-full"
                                    src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/robert-brown.png"
                                    alt="Robert image">
                                <div
                                    class="flex absolute justify-center items-center ml-6 -mt-5 size-5 bg-purple-500 rounded-full border border-white">
                                    <svg class="size-2 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="pl-3 w-full">
                                <div class="text-gray-500 font-normal text-sm mb-1.5"><span
                                        class="font-semibold text-gray-900">Robert Brown</span> posted a
                    ...
                    <a href="#"
                        ...
                        <div class="inline-flex items-center ">
                            <svg aria-hidden="true" class="mr-2 size-5" fill="currentColor" viewBox="0 0 20 20"
                ...
                <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg"
                    ...
                    <div class="grid grid-cols-3 gap-4 p-4">
                        <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-1000 group">
                            <svg class="mx-auto mb-2 size-5 text-gray-400 group-hover:text-gray-500" aria-hidden="true"
                ...
                <!-- Profile menu -->
                <div class="hidden md:flex shrink-0 justify-center items-center space-y-0.5">
                    <button type="button"
                        class="flex items-center mx-3 bg-gray-100 rounded-md focus:ring-4 focus:ring-gray-300 px-3 py-1.5 space-x-0.5"
                        ...
                        <hr class="w-5 text-gray-400 rotate-90" />

                        <span class="flex flex-col items-start -space-y-1">
                            <span class="text-xs">Trekkscooters</span>
                            <span class="text-brand-400 text-xxs">Super Admin</span>
                        </span>
                    </button>
                </div>

                <button type="button"
                    class="md:hidden flex mx-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                    id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
                    <span class="sr-only">Open user menu</span>
                    <img class="size-8 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg"
                        alt="user photo">
                </button>
                ...
                <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow"
                    ...
                    <ul class="py-1 text-gray-500" aria-labelledby="dropdown">
                        <li>
                            <a href="#" class="block py-2 px-4 text-sm hover:bg-gray-1000">My
                                profile</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 px-4 text-sm hover:bg-gray-1000">Account
                                settings</a>
                        </li>
                    </ul>
                    <ul class="py-1 text-gray-500" aria-labelledby="dropdown">
                        <li>
                            <a href="#" class="flex items-center py-2 px-4 text-sm hover:bg-gray-1000">
                                <svg class="mr-2 size-4 text-gray-400" aria-hidden="true"
                        ...
                        <li>
                            <a href="#" class="flex justify-between items-center py-2 px-4 text-sm hover:bg-gray-1000">
                                <span class="flex items-center">
                                    <svg class="mr-2 size-4 text-primary-600" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                        <path
                                ...
                                <svg class="size-2.5 text-gray-400" aria-hidden="true"
                    ...
                    <ul class="py-1 text-gray-500" aria-labelledby="dropdown">
                        <li>
                            <a href="#" class="block py-2 px-4 text-sm hover:bg-gray-1000">Sign
                                out</a>
                        </li>
                    </ul>
                </div>
