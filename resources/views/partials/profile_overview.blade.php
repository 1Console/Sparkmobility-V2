<div class="flex items-center justify-between space-x-1">
	...
	<span class="text-[0.6rem]">Monday, September 20th</span>
	...
	<a href="#">
		...
		>
			<path
				d="M2.36836 14.49C2.78836 20.4983 7.88669 25.3867 13.9884 25.655C18.2934 25.8417 22.1434 23.835 24.4534 20.6733C25.41 19.3783 24.8967 18.515 23.2984 18.8067C22.5167 18.9467 21.7117 19.005 20.8717 18.97C15.1667 18.7367 10.5 13.965 10.4767 8.32999C10.465 6.81332 10.78 5.37832 11.3517 4.07165C11.9817 2.62499 11.2234 1.93665 9.76502 2.55499C5.14502 4.50332 1.98336 9.15832 2.36836 14.49Z"
				stroke="#C7C7C7"
				stroke-opacity="0.8"
				stroke-width="1.5"
				stroke-linecap="round"
	...
	<a href="#">
		...
		>
			<path
				d="M14.0234 3.39499C10.1618 3.39499 7.02344 6.53332 7.02344 10.395V13.7667C7.02344 14.4783 6.7201 15.5633 6.35844 16.17L5.01677 18.3983C4.18844 19.775 4.7601 21.3033 6.27677 21.8167C11.3051 23.4967 16.7301 23.4967 21.7584 21.8167C23.1701 21.35 23.7884 19.6817 23.0184 18.3983L21.6768 16.17C21.3268 15.5633 21.0234 14.4783 21.0234 13.7667V10.395C21.0234 6.54499 17.8734 3.39499 14.0234 3.39499Z"
				stroke="#403D3D"
				stroke-width="1.5"
				stroke-miterlimit="10"
				stroke-linecap="round"
			/>
			<path
				d="M16.1817 3.73334C15.82 3.62834 15.4467 3.54667 15.0617 3.5C13.9417 3.36 12.8683 3.44167 11.865 3.73334C12.2033 2.87 13.0433 2.26334 14.0233 2.26334C15.0033 2.26334 15.8433 2.87 16.1817 3.73334Z"
				stroke="#403D3D"
				stroke-width="1.5"
				stroke-miterlimit="10"
				stroke-linecap="round"
	...
	<a href="#">
		<div class="flex items-center justify-center space-x-1">
			...
			>
				<g clip-path="url(#clip0_164_30008)">
					<path
						d="M19.9999 3.33398C10.7949 3.33398 3.33325 10.7957 3.33325 20.0006C3.33325 29.2056 10.7949 36.6673 19.9999 36.6673C29.2049 36.6673 36.6666 29.2056 36.6666 20.0006C36.6666 10.7957 29.2049 3.33398 19.9999 3.33398Z"
						stroke="#BFBEBE"
						stroke-width="1.5"
						stroke-linecap="round"
						stroke-linejoin="round"
					/>
					<path
						d="M7.11816 30.5767C7.11816 30.5767 10.8332 25.8333 19.9998 25.8333C29.1665 25.8333 32.8832 30.5767 32.8832 30.5767M19.9998 20C21.3259 20 22.5977 19.4732 23.5354 18.5355C24.473 17.5979 24.9998 16.3261 24.9998 15C24.9998 13.6739 24.473 12.4021 23.5354 11.4645C22.5977 10.5268 21.3259 10 19.9998 10C18.6737 10 17.402 10.5268 16.4643 11.4645C15.5266 12.4021 14.9998 13.6739 14.9998 15C14.9998 16.3261 15.5266 17.5979 16.4643 18.5355C17.402 19.4732 18.6737 20 19.9998 20Z"
						stroke="#BFBEBE"
						stroke-width="1.5"
						stroke-linecap="round"
						stroke-linejoin="round"
					...
					<rect
						...
						height="38"
						rx="19"
						stroke="url(#paint0_linear_164_30008)"
						stroke-width="2"
					/>
				...
				<defs>
					<pattern
						...
						height="1"
					>
						<use xlink:href="#image0_164_30008" transform="scale(0.00271739)" />
					</pattern>
					<linearGradient
						id="paint0_linear_164_30008"
						x1="5.5"
						y1="7"
						x2="40"
						y2="33.5"
					...
					>
						<stop stop-color="#4EA685" />
						<stop offset="1" />
					</linearGradient>
					<clipPath id="clip0_164_30008">
			...
			<div class="text-[0.6rem]">
				...
				<p>
					Account:
					<a href="#" class="text-[#4EA685]">Super Admin</a>
				</p>
			</div>
		</div>
	</a>
