    ...
    <body class="font-sans text-gray-900 antialiased overflow-y-auto">
        <div class="flex h-screen text-[#9E9E9E]  bg-white dark:bg-gray-900">
            ...
            <div class=" bg-white flex-none  w-96 px-6 py-4 text-sm overflow-y-auto">
                <div class=" space-x-6  ">
                    <h2 class="font-black">ACTIVE ACCOUNTS &nbsp; <button class=" bg-[#DCEDE7] rounded-2xl inline py-1 px-3 ">500</button></h2>
                    {{-- <button class=""></button> --}}
                </div>
                ...
                <div class=" bg-white flex-1 mx-auto  w-full px-10  py-4 overflow-x-auto overflow-y-auto">
                        <div class="relative w-full">
                           <input type="text" class=" w-full px-8 outline-none outline-white rounded-2xl " placeholder=" Search...">
                           <a href="#">
                            {{-- <img src="images/formIcons/search.png" class="absolute inset-0 mt-3 ml-2" alt=""> --}}
                            <svg class="absolute inset-0 mt-3 ml-2" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.16663 16.6667C13.3088 16.6667 16.6666 13.3088 16.6666 9.16666C16.6666 5.02452 13.3088 1.66666 9.16663 1.66666C5.02449 1.66666 1.66663 5.02452 1.66663 9.16666C1.66663 13.3088 5.02449 16.6667 9.16663 16.6667Z" stroke="#121212" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M15.7749 17.2415C16.2166 18.5748 17.2249 18.7082 17.9999 17.5415C18.7082 16.4748 18.2416 15.5998 16.9582 15.5998C16.0082 15.5915 15.4749 16.3332 15.7749 17.2415Z" stroke="#121212" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        ...
                        <div class=" flex mt-12 items-center justify-start space-x-28 px-0 text-black">
                            ...
                            <div class="flex space-x-2">
                                ...
                                <div class="relative">
                                    ...
                                    <button class="absolute -top-3 -right-12 bg-[#DCEDE7] text-[#4EA685] text-[0.6rem] w-27 rounded-2xl inline py-1 px-2 "> <span class="font-black">1000</span> added</button>
                                ...
                                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                                            ...
                                            <div class="flex items-center space-x-3 w-full md:w-auto">
                                                ...
                                                <div id="filterDropdown" class="z-10 hidden w-48 p-3 bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                                                        <li class="flex items-center">
                                                            <input id="apple" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                                            <label for="apple" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Voi Scooter (19)</label>
                                                        </li>
                                                        <li class="flex items-center">
                                                            <input id="fitbit" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                                            <label for="fitbit" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Scoot (29)</label>
                                                        </li>
                                                        <li class="flex items-center">
                                                            <input id="razor" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                                            <label for="razor" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Beam (49)</label>
                                                        </li>
                                                        <li class="flex items-center">
                                                            <input id="nikon" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                                            <label for="nikon" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Bunny (12)</label>
                                                        </li>
                                                        <li class="flex items-center">
                                                            <input id="benq" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                                            <label for="benq" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Circ (74)</label>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="overflow-x-auto">
                                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                                <tr>
                                                    <th scope="col" class="px-4 py-3">Partners <p class=" capitalize">*Click Admin you want to see</p> </th>
                                                ...
                                                <tr class="border-b dark:border-gray-700">
                                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        <div class=" p-0 m-0 flex items-center justify-start gap-2">
                                                            <img src="images/partners/partnerImage1.png" class=" h-5 w-5" alt="">
