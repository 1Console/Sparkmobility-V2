  ...
  <body class="font-sans text-gray-900 antialiased overflow-x-hidden overflow-y-auto ">
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
      <nav
        ...
        <div class="flex flex-wrap justify-between items-center">
          ...
          <div class="flex items-center lg:order-2">
            ...
            <button type="button" data-drawer-target="user-drawer" data-drawer-show="user-drawer"
              data-drawer-placement="right" aria-controls="user-drawer"
              class="flex mx-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
              id="user-menu-button">
              <span class="sr-only">Open user menu</span>
              <img class="w-8 h-8 rounded-full"
                src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png" alt="user photo" />
            </button>
          </div>
        </div>
      </nav>
      ...
      <div class="relative flex h-full w-full flex-1">
        <aside
          class="fixed top-0 left-0 z-40 w-64 h-screen pt-14 lg:pt-0 transition-transform -translate-x-full bg-white border-r border-gray-200 lg:!translate-x-0 dark:bg-gray-800 dark:border-gray-700"
        ...
        <main
          class="dark:bg-gray-900 w-full flex-1 p-4 flex flex-col items-stretch h-full space-y-4 lg:mx-64 pt-20 lg:pt-4">
          ...
          <div class="overflow-y-auto  py-5 px-3 h-full bg-white dark:bg-gray-800">
            <div class="flex flex-col items-center">
              <img class="w-20 h-20 rounded-full"
                src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/lana-byrd.png" alt="user photo" />
              ...
              <div class="flex items-center justify-center">
                ...
                <!-- Notifications -->
                <button type="button" data-dropdown-toggle="notification-dropdown-sidebar"
                  class="p-2 mr-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                  <span class="sr-only">View notifications</span>
                  <!-- Bell icon -->
                  <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                ...
                <!-- Question Mark -->
                <button type="button" data-dropdown-toggle="support-dropdown"
                  class="p-2 mr-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
            ...
            <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
              ...
              <li>
                ...
                <ul id="dropdown-tasks" class="hidden py-2 space-y-2">
                  <li>
                    <a href="#"
                      class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">To
                      do</a>
                  </li>
                  <li>
                    <a href="#"
                      class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">In
                      progress</a>
                  </li>
                  <li>
                    <a href="#"
                      class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Completed</a>
                  </li>
                </ul>
              </li>
              <li>
