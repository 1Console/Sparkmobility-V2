				...
				<ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
					...
					<li aria-current="page">
						<div class="flex items-center">
							...
							<span class="text-xs font-medium text-gray-500">Active rides</span>
						</div>
					</li>
				</ol>
			</nav>
		...
		<div class="rounded-lg border border-gray-200 bg-white p-4">
			...
			<div class="relative mt-4 flex w-auto items-end px-4 py-5">
				<div class="flex">
					...
					<div>
						<div class="text-xl font-medium text-gray-600">Active Rides</div>
						<p class="text-sm text-zinc-500">Monitor all active rides here</p>
					</div>
				</div>
			</div>
								...
								<tr>
									<th scope="col" class="p-4">
										<div class="flex items-center">
											...
											/>
											<label for="check-all-active-rides" class="sr-only">
												checkbox
											</label>
										</div>
									</th>
