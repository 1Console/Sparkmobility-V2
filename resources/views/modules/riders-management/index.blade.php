        ...
        <nav class="flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                <li class="inline-flex items-center">
                    <a href="#" class="inline-flex items-center text-sm font-normal text-brand-400 hover:text-gray-500">
                        <svg class="size-2.5 me-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <svg class="text-gray-400 size-6 mx-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                ...
                <tbody>
                    <tr
                        ...
                        <th scope="row"
                            ...
                            <img class="size-10 rounded-full" src="/docs/images/people/profile-picture-1.jpg"
                                alt="Jese image">
                            <div class="ps-3">
                    ...
                    <tr
                        ...
                        <th scope="row"
                            ...
                            <img class="size-10 rounded-full" src="/docs/images/people/profile-picture-3.jpg"
                                alt="Jese image">
                            <div class="ps-3">
                    ...
                    <tr
                        ...
                        <th scope="row"
                            class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <img class="size-10 rounded-full" src="/docs/images/people/profile-picture-2.jpg"
                                alt="Jese image">
                            <div class="ps-3">
                    ...
                    <tr
                        ...
                        <th scope="row"
                            class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <img class="size-10 rounded-full" src="/docs/images/people/profile-picture-5.jpg"
                                alt="Jese image">
                            <div class="ps-3">
                    ...
                    <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <th scope="row"
                            class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <img class="size-10 rounded-full" src="/docs/images/people/profile-picture-4.jpg"
                                alt="Jese image">
                            <div class="ps-3">
