<div class="mt-16 h-full w-full">
	<hr />
	<div class="mt-8">
		<h3 class="text-xl font-extrabold text-[#727272]">Created Commands</h3>
					...
					<table class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
						...
						>
							<tr>
								...
								<th scope="col" class="w-30 px-1 py-3">Date Created</th>
							...
							<tr class="border-b dark:border-gray-700">
								...
								<td class="px-4 py-3">
									<div class="flex items-center gap-2">
										<span class="border-2 border-l-gray-50">
											<img src="{{ url("images/recall.png") }}" alt="" />
										</span>
										<span class="border-2 border-l-gray-50">
											<img src="{{ url("images/edit.png") }}" alt="" />
										</span>
										<span class="border-2 border-l-gray-50">
											<img src="{{ url("images/delete.png") }}" alt="" />
										</span>
									</div>
								</td>
							</tr>
