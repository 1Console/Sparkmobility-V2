		...
		<div class="flex items-start justify-start space-x-1">
			...
			<div class="flex-1">
				...
				<div class="mt-10 text-black">
					<h1 class="mt-6 text-3xl font-black text-black">Commands</h1>
				...
				<div class="mt-12 flex items-center justify-start space-x-24 px-0 text-black">
					<div class="flex space-x-2">
						...
						<div class="relative">
							...
							<button
								class="w-27 absolute -right-10 -top-1 inline rounded-2xl bg-[#DCEDE7] px-2 py-1 text-[0.6rem] text-[#4EA685]"
							>
								<span class="font-black">05</span>
								active
							</button>
						</div>
					</div>
					<div class="flex space-x-2">
						...
						<div class="relative">
							...
							<button
								class="w-27 absolute -right-10 -top-1 inline rounded-2xl bg-[#DCEDE7] px-2 py-1 text-[0.6rem] text-[#4EA685]"
							>
								<span class="font-black">200</span>
								added
							</button>
						</div>
					</div>
					<div class="flex space-x-2">
						...
						<div class="relative">
							...
							<button
								class="w-27 absolute -right-12 -top-1 inline rounded-2xl bg-[#DCEDE7] px-2 py-1 text-[0.6rem] text-[#4EA685]"
							>
								<span class="font-black">1000</span>
								added
							</button>
						</div>
					</div>
				...
				<div class="mx-0 mt-14 flex items-center justify-between px-0">
					<div class="space-y-1">
						<h3 class="text-lg font-extrabold text-[#727272]">Management Insight</h3>
						<p>Monitor admin performance by month and year</p>
					</div>
					<div>
						<select name="" id="" class="w-full rounded-full font-extrabold">
							<option class="" value="">April 1st - 30th, 2023</option>
						</select>
					</div>
				</div>

				<div class="m-0 mt-10 flex w-full justify-center px-0">
								...
								>
									...
									<tbody>
										<tr class="border-b dark:border-gray-700">
											...
											>
												<div
													class="m-0 flex items-center justify-start gap-2 p-0"
												>
													<img
