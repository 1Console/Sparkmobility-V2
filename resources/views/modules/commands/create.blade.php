            ...
            <div class=" flex mt-12 items-center justify-start space-x-24 px-0 text-black">
                ...
                <div class="flex space-x-2">
                    ...
                    <div class="relative">
                        ...
                        <button
                            class="absolute -top-1 -right-12 bg-[#DCEDE7] text-[#4EA685] text-[0.6rem] w-27 rounded-2xl inline py-1 px-2 ">
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        <th scope="col" class="px-4 py-3">Partners <p class=" capitalize">*Click Admin
                                                you want to see</p>
                                        </th>
