...
<div class=" flex flex-col">
    {{-- first column: divided into 2 columns --}}
    <div class=" flex items-start justify-start space-x-1">
           
          {{-- // search, analytics overview, mgt insight, partner --}}
       <div class="  flex-1">
           <div class="relative w-full  overflow-y-auto">
               {{-- <input type="text" id="simple-search" placeholder="Search...." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search" required=""> --}}
            ...
            <div class=" mt-10 text-black">
                <h1 class=" font-black text-black text-3xl mt-6">Commands</h1>
                <p class="mt-4">Create and manage commands here</p>
            </div>
            ...
            <div class=" flex mt-12 items-center justify-start space-x-24 px-0 text-black">
                ...
                <div class="flex space-x-2">
                    ...
                    <div class="relative">
                        ...
                        <button class="absolute -top-1 -right-12 bg-[#DCEDE7] text-[#4EA685] text-[0.6rem] w-27 rounded-2xl inline py-1 px-2 "> <span class="font-black">1000</span> added</button>
    ...
    {{-- second column for reviews --}}
    @include('modules.commands.created_commands')
