					...
					>
						...
						<div>
							...
							<button
								...
								data-dropdown-toggle="fleetDropdownRadio"
								class="inline-flex items-center rounded bg-white px-3 py-2.5 text-xs font-medium text-gray-500 hover:bg-brand-100 md:text-sm"
							>
								<span class="sr-only">Fleet filter button</span>
								Fleet
								<svg
									class="ms-2.5 size-2.5"
									aria-hidden="true"
									...
									<li>
										...
										>
											...
											>
												...
												<span class="ms-4 inline-flex">Free</span>
											</div>
										</label>
									</li>
									<li>
										...
										>
											...
											>
												...
												<span class="ms-4 inline-flex">In-Use</span>
											</div>
										</label>
									</li>
                                    <li>
						...
						>
							<thead class="bg-gray-50 text-xs uppercase text-gray-500">
								<tr>
									...
									<th scope="col" class="px-4 py-3">
										<div class="flex items-center">
											<span class="shrink-0">Vehicle</span>
										</div>
									</th>
									<th scope="col" class="px-4 py-3">
										<div class="flex items-center">
									...
									<th scope="col" class="px-4 py-3">
										<div class="flex items-center">
											<span class="shrink-0">Vehicle State</span>
												
										</div>
									</th>
									<th scope="col" class="px-4 py-3">
										<div class="flex items-center">
											<span class="shrink-0">Maintenance</span>
									...
									<th scope="col" class="px-4 py-3">
										<div class="flex items-center">
											<span class="shrink-0">Time Activated</span>
