...
export default function NavBar({ active = false, className = "", children, ...props }) {
	return (
		...
		// 		{children}
		// 	</Link>
		<header className="fixed z-30 w-full antialiased">
			<nav className="border-b border-gray-200 bg-white px-4 py-2.5 shadow lg:px-6">
					...
					<div className="flex items-center justify-between space-x-2 md:justify-end lg:order-2">
						...
						<span className="hidden shrink-0 items-center text-sm sm:inline-flex">
							<svg
								...
								strokeWidth="1.5"
								stroke="currentColor"
								className="me-1.5 size-4 text-slate-500"
							>
								<path
									strokeLinecap="round"
									strokeLinejoin="round"
						...
						<button
							...
							type="button"
							className="rounded-lg p-2 text-gray-500 hover:bg-brand-100 hover:text-gray-900 lg:hidden"
						>
						...
						<button
							...
							className="mr-1 rounded-lg p-2 text-gray-500 hover:bg-brand-100 hover:text-gray-900"
						>
							...
							<div className="relative">
								...
								<div className="absolute -right-2.5 top-0.5 me-2 size-1 rounded-full bg-green-500"></div>
							</div>
						</button>
						{/* <!-- Dropdown menu grid --> */}
						<div
							className="z-50 my-4 hidden max-w-sm list-none divide-y divide-gray-100 overflow-hidden rounded bg-white text-base shadow-lg"
						...
						>
							...
							<div>
								<a href="#" className="flex border-b px-4 py-3 hover:bg-brand-100">
									<div className="shrink-0">
										...
										/>
										<div className="bg-brand-text-brand-400 absolute -mt-5 ml-6 flex size-5 items-center justify-center rounded-full border border-white">
											<svg
												className="size-2 text-brand-400"
												aria-hidden="true"
												xmlns="http://www.w3.org/2000/svg"
												fill="currentColor"
												viewBox="0 0 18 18"
								...
								<a href="#" className="flex border-b px-4 py-3 hover:bg-brand-100">
									<div className="shrink-0">
										...
										/>
										<div className="absolute -mt-5 ml-6 flex size-5 items-center justify-center rounded-full border border-white bg-gray-900">
											<svg
								...
								<a href="#" className="flex border-b px-4 py-3 hover:bg-brand-100">
									<div className="shrink-0">
										...
										/>
										<div className="absolute -mt-5 ml-6 flex size-5 items-center justify-center rounded-full border border-white bg-red-600">
											<svg
												className="size-2 text-white"
												aria-hidden="true"
												xmlns="http://www.w3.org/2000/svg"
								...
								<a href="#" className="flex border-b px-4 py-3 hover:bg-brand-100">
									<div className="shrink-0">
										...
										/>
										<div className="absolute -mt-5 ml-6 flex size-5 items-center justify-center rounded-full border border-white bg-green-400">
											<svg
												className="size-2 text-white"
												aria-hidden="true"
												xmlns="http://www.w3.org/2000/svg"
								...
								<a href="#" className="flex px-4 py-3 hover:bg-brand-100">
									<div className="shrink-0">
										<img
											className="size-11 rounded-full border-2 border-white"
											...
											alt="Robert image"
										/>
										<div className="absolute -mt-5 ml-6 flex size-5 items-center justify-center rounded-full border border-white bg-purple-500">
											<svg
												className="size-2 text-white"
												aria-hidden="true"
												xmlns="http://www.w3.org/2000/svg"
							...
							<a
								href="#"
								className="block bg-gray-50 py-2 text-center text-base font-medium text-gray-900 hover:bg-brand-100"
							>
						...
						<button
							...
							className="rounded-lg p-2 text-gray-500 hover:bg-brand-100 hover:text-gray-800"
						>
							<span className="sr-only">View notifications</span>
							{/* <!-- Icon --> */}
							<svg
						...
						<div className="flex shrink-0 items-center justify-center">
							<button
								type="button"
								className="flex items-center space-x-0.5 rounded-md px-3 py-1.5 hover:bg-brand-100 focus:outline-none focus:ring-4 focus:ring-gray-100"
								id="user-menu-button"
							...
							>
								...
								<ul className="py-1 text-gray-500" aria-labelledby="dropdown">
									<li>
										<a
											href="#"
											className="flex items-center px-4 py-2 text-sm hover:bg-brand-100"
										>
											<svg
									...
									<li>
										<a
											href="#"
											className="flex items-center justify-between px-4 py-2 text-sm hover:bg-brand-100"
										>
											<span className="flex items-center">
												<svg
													className="mr-2 size-4 text-brand-400"
													aria-hidden="true"
													xmlns="http://www.w3.org/2000/svg"
													fill="currentColor"
													viewBox="0 0 20 20"
