...
export default function Stats() {
	return (
		<>
			<div className="mb-5 grid w-full grid-cols-1 gap-4 md:grid-cols-3">
				<div className="relative flex w-full flex-col items-start space-y-0.5 rounded-lg bg-white p-6 shadow lg:max-w-sm lg:p-8 xl:flex-row xl:justify-center">
					<span className="absolute right-3 top-3 rounded-full bg-brand-100 px-2 py-0.5 text-xxs font-medium tracking-wide text-brand-400">
						505 Active
					</span>
					...
					<div>
						<div className="text-xl font-medium text-gray-600">Riders</div>
						<p className="text-sm text-zinc-500">Manage all riders</p>
					</div>
				</div>
				...
				<div className="relative flex w-full flex-col items-start space-y-0.5 rounded-lg bg-white p-6 shadow lg:max-w-sm lg:p-8 xl:flex-row xl:justify-center">
					...
					<div>
						<div className="text-xl font-medium text-gray-600">Fleets</div>
						<p className="text-sm text-zinc-500">Manage all fleets</p>
					</div>
				</div>
				...
				<div className="relative flex w-full flex-col items-start space-y-0.5 rounded-lg bg-white p-6 shadow lg:max-w-sm lg:p-8 xl:flex-row xl:justify-center">
					...
					<div>
						<div className="text-xl font-medium text-gray-600">Vehicles</div>
						<p className="text-sm text-zinc-500">Manage all vehicles</p>
					</div>
				</div>
			</div>

			<div className="mb-5 rounded-lg border border-gray-200 bg-white p-8 shadow">
				<div className="flex flex-col space-y-2 md:flex-row md:justify-between">
					<div className="space-y-1">
						<h3 className="text-lg font-bold">Management Insight</h3>
					...
					<div className="inline-flex space-x-3">
						<div>
							<button
								...
								type="button"
								className="inline-flex items-center rounded-full border border-gray-200 bg-white px-4 py-2 text-sm font-thin text-gray-500 hover:border-brand-400 hover:text-brand-400 focus:z-20 focus:outline-none focus:ring-2 focus:ring-brand-200"
							>
								This week
								<svg
									className="ms-2.5 size-5"
									aria-hidden="true"
									xmlns="http://www.w3.org/2000/svg"
									fill="none"
									viewBox="0 0 24 24"
							...
							<div
								id="lastDaysdropdown"
								className="z-20 hidden w-44 divide-y divide-solid divide-gray-400 rounded-lg bg-white shadow"
							>
								<ul
								...
								>
									<li>
										<a
											href="#"
											className="block px-4 py-2 hover:bg-brand-100 hover:text-brand-400"
										>
											Yesterday
										</a>
									</li>
						...
						<div>
							<button
								data-dropdown-toggle="monthsDropdown"
								data-dropdown-placement="bottom"
								type="button"
								className="inline-flex items-center rounded-full border border-gray-200 bg-white px-4 py-2 text-sm font-thin text-gray-500 hover:border-brand-400 hover:text-brand-400 focus:z-20 focus:outline-none focus:ring-2 focus:ring-brand-200"
							>
				...
				<div className="mt-10 w-full">
					...
					<div className="my-4 flex justify-end">
						<a
							href="#"
							className="inline-flex items-center rounded px-3 py-2 text-sm font-medium uppercase text-brand-400 hover:bg-brand-100 hover:font-semibold hover:text-brand-400"
						>
							Users Report
							<svg
