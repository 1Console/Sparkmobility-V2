...
class BannerController extends Controller
{
    ...
    {
        //  dd(Banner::all());
        //  dd($this->bannerRepository->showAll());
    ...
    public function create()
    {
        ...
        return view('modules.marketing.banners.create');
    }
    ...
    public function store(StoreBannerRequest $request)
    {
        ...
        return redirect()->route('marketing.banners.create')->with('success','Banner was successfully added');
    }
