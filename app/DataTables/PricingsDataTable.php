...
class PricingsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->editColumn('action', function ($item) {
                ...
                $actions = '<a class href="'.route('pricing-plans.show', $item->id).'">'.$view_icon.'</a> | ';
                $actions .= '<a class href="'.route('pricing-plans.edit', $item->id).'">'.$edit_icon.'</a> ';
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('first_unit_unlock_fee'),
            Column::make('next_unit_fee'),
